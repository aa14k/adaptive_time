"""
This is a modified version of the MountainCar-v0 environment from OpenAI Gym.
    This version allows us to change the granularity of the physical simulation.
    The rewards are normalized so that 1s of simulation time is worth -1.0 reward.
...
gym.register(
    id="MountainCar-OURS-v0",
    entry_point="adaptive_time.environments.gym_mountain_car:MountainCarEnv",
...
class MountainCarEnv(gym.Env):
    ...
    * v0: Initial versions release
    ...
    def __init__(self, dt=1., render_mode: Optional[str] = None, goal_velocity=0):
